...
void wakeup_wait(wait_queue_t *queue, wait_t *wait, uint64_t wakeup_flags, bool del);
void wakeup_first(wait_queue_t *queue, uint64_t wakeup_flags, bool del);
void wakeup_queue(wait_queue_t *queue, uint64_t wakeup_flags, bool del);

void wait_current_set(wait_queue_t *queue, wait_t *wait, uint64_t wait_state);
